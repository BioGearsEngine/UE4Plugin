...
public class VH_BioGears : ModuleRules
{
	...
	private string ThirdpartyBuildDir { get { return Path.GetFullPath(Path.Combine(ModuleDirectory, "../../../../../ThirdParty/")); } }
	private string EngineBinaryPath { get { return Path.GetFullPath(Path.Combine(ModuleDirectory, "../../../../../Engine/Binaries/")); } }
	...
	private bool LoadBioGears()
    {
		...
		{
			System.Console.WriteLine("Android detected building for both armeabi-v7a and arm64-v8a");
